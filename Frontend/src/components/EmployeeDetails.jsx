...
import { fetchAttendance } from "../features/employee/employeeAttandanceSlice"
import { useParams } from "react-router-dom"
import { parseISO, format } from 'date-fns'
import { fetchEmployeeById } from "../features/employee/ManageEmployeeSlice"
...
export default function EmployeeDetails() {
  ...
  const {id}=useParams()
  const {employee,fetching} = useSelector((state)=>state.manageEmployee)
 ...
 const handlePeriodChange = (period, startDate = null, endDate = null) => {
  ...
  if (period === "custom") {
    ...
    if (startDate && endDate) {
      dispatch(fetchAttendance({ id: id, start_date: startDate, end_date: endDate }))
    }
  } else {
    ...
    if (start && end) {
      ...
      dispatch(fetchAttendance({ id: id, start_date: formattedStart, end_date: formattedEnd }))
    }
  }
}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">{fetching?<PulseLoader color='#16A34A' size={10} />:employee?.name}</h1>
          </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex items-end">
                  <button
                    onClick={() => dispatch(fetchAttendance({id, start_date: customStartDate, end_date: customEndDate }))}
